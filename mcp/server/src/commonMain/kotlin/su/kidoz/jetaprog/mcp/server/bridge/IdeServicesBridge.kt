package su.kidoz.jetaprog.mcp.server.bridge

/**
 * Bridge interface for IDE services that the MCP server can use.
 *
 * This interface is defined in mcp:server to avoid circular dependencies.
 * Implementations are provided by mcp:bridge module.
 */
...
/**
 * Adapter for build system operations.
 */
...
/**
 * Adapter for terminal operations.
 */
...
/**
 * Adapter for version control operations.
 */
...
/**
 * Adapter for workspace operations.
 */
